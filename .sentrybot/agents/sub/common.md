# Sub-Agent: common-specialist

## Uzmanlık
`EmotionRender` ve `common` modül ekosistemi.

## Bilgi kaynağı
`.sentrybot/obsidian/modules/common.md`

## Bileşen haritası
- `EmotionRender` — Resolved render hints for a canonical emotion.
