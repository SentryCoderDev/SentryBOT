...
class SpeechService:
    ...
    def finalize_stt(self, text: str) -> tuple[str, str]:
        ...
        resolved_text, resolved_lang = resolve_stt_text_and_language(
            ...
            primary_lang=self.recognizer.cfg.get("language", "tr") if hasattr(self.recognizer, 'cfg') else "tr",
            secondary_lang=self._secondary_recognizer.cfg.get("language", "en") if self._secondary_recognizer and hasattr(self._secondary_recognizer, 'cfg') else "en",
