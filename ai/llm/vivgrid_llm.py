"""MARK: VivGrid LLM — premium model hub (OpenAI-compatible)
Rate Limit: 6 RPM, 20k TPM | Models: gpt-4.1, gemini-2.5-pro, deepseek-r1
"""
...
import os
import openai
from modules.llm._helper import build_messages, tool_loop, to_schema, inject_schema_hint

# MARK: Client Setup
_key = os.environ.get("VIVGRID_API_KEY", "")
if not _key:
    raise ImportError("VIVGRID_API_KEY not set")

client = openai.OpenAI(api_key=_key, base_url="https://api.vivgrid.com/v1")
MODEL = "DeepSeek-V3.2"
