...
public:
  ...
  void update(){
    ...
    // PID loop removed: this firmware build uses hall encoder feedback (hardware) instead
    // of the previous software estimator. Legacy PID APIs remain but are effectively no-op.
  }
